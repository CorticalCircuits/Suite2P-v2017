...
for i = 1:length(h.dat.stat);PO(i) = mod(h.dat.stat(i).paras(1),180)/180;end
H1(iclust1>0) = PO(iclust1(iclust1>0));
H2(iclust2>0) = PO(iclust2(iclust2>0));
end
